...
class AdminEbook extends Controller
{
    ...
    function tambahAct(Request $req){
        ...
        return redirect('Admin/ebook')->with('success', 'Data berhasil disimpan !');
    }
    ...
    function update($ebook) {
        ...
        return view('Admin.ebook.update', $data);
    }
    ...
    function updateAct(Ebook $ebook, Request $req) {
        ...
        // Mengarahkan pengguna kembali ke halaman daftar ebook dengan pesan sukses
        return redirect('Admin/ebook')->with('success', 'Data berhasil diedit !');
    }
