        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card rounded-md shadow-md">
                    <div class="card-body">
                        <form action="{{ url('Admin/berita/updateAct', $list->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        <label for="">Nama berita</label>
                                        <input type="text" name="nama_berita" value="{{ $list->nama_berita }}" class="form-control" placeholder="Nama berita ...">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        <label for="">Kategori</label>
                                        <select name="kategori_berita" id="" class="form-control">
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <img id="gambarPreview" src="{{ url("public/$list->gambar_berita") }}" class="rounded float-end" width="50%" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-12">
                                    <div class="form-group">
