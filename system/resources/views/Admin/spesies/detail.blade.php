...
@section('content')
        ...
        @foreach ($list->galeri as $g)
            <div class="col-md-4">
                <div class="card card-images">
                    ...
                    <div class="card-button">
                        ...
                        {{-- <form action="{{ url('Admin/spesies/hapusGambar', $g->id) }}" method="POST">
                            @csrf
                            @method('DELETE') --}}
                        <a href="{{ url('Admin/spesies/hapusGambar', $g->id) }}" class="btn btn-danger mx-2" onclick="return confirm('Yakin ingin menghapus data ini ?!')">HAPUS</a>
                    </div>
                </div>
            </div>
            <!-- Modal Update-->
            <div class="modal fade" id="update{{ $g->id }}" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{ url('Admin/spesies/updateGambar', $g->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ url('Admin/spesies/tambahGambar') }}" method="POST" enctype="multipart/form-data">
