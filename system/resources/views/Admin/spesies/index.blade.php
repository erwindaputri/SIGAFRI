                                ...
                                <td>
                                        ...
                                        <center>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ url('Admin/spesies/update', encrypt($item->id)) }}" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="{{ url('Admin/spesies/hapus', $item->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data ini ?!')">
                                    ...
                                    {{-- @if ($item->level == 1)
                                    <form action="{{ url('Admin/spesies/konfirmasi-spesies',$item->id) }}" method="POST">
                                    @csrf --}}
                                    {{-- @method("PUT")
