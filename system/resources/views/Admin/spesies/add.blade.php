        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card rounded-md shadow-md">
                    <div class="card-body">
                        <form action="{{ url('Admin/spesies/tambahAct') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{-- <input type="text" name="id_anggota" class="form-control" value="{{ Auth::guard('super-admin')->user()->id }}" hidden> --}}
                            <div class="row">
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        <label for="">Nama Spesies</label>
                                        <input type="text" name="nama_spesies" class="form-control" placeholder="Nama spesies ..." required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="famili" class="form-control" placeholder="Famili spesies ..." required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-12">
                                    <div class="form-group">
                                        <label for="">Kategori</label>
                                        <select name="kategori_spesies" id="" class="form-control" required>
                                ...
                                <div class="col-lg-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="kategori_jenis" id="" class="form-control" required>
                                            <option value="">--- Pilih ---</option>
                                ...
                                <div class="col-lg-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="gambar" type="file" name="gambar_spesies[]" class="form-control" placeholder="Famili spesies ..." multiple required>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"data-toggle="modal" id="daerah" data-target="#exampleModal" class="form-control" placeholder="Daerah pesebaran spesies ..." required>
                                    </div>
                                </div>
                                <div class="col-12">
