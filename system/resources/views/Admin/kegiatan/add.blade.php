        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card rounded-md shadow-md">
                    <div class="card-body">
                        <form action="{{ url('Admin/kegiatan/tambahAct') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="gambar" type="file" name="gambar_kegiatan" class="form-control" placeholder="Famili spesies ..." multiple required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a href="{{ url('Admin/kegiatan') }}" class="btn btn-warning">BATAL</a>
