        ...
        <div class="col-md-12">
            <div class="card rounded-none">
                <div class="card-header">
                    <a href="{{ url('Admin/ebook/add') }}" class="btn btn-success btn-sm float-right">
                        Tambah data
                    </a>
                </div>
                <div class="card-body">
                                        ...
                                        <td>
                                            <center>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ url('Admin/ebook/hapus', encrypt($ebook->id)) }}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data ini ?!')">
