        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card rounded-md shadow-md">
                    <div class="card-body">
                        <form action="{{ url('SuperAdmin/kegiatan/updateAct', $list->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        <label for="">Nama Kegiatan</label>
                                        <input type="text" name="nama_kegiatan" value="{{ $list->nama_kegiatan }}" class="form-control" placeholder="Nama Kegiatan ..."required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <img id="gambarPreview" src="{{ url("public/$list->gambar_kegiatan") }}" class="rounded float-end" width="50%" alt="..."required>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-12">
                                    <div class="form-group">
