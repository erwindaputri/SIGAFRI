        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card rounded-md shadow-md">
                    <div class="card-body">
                        <form action="{{ url('SuperAdmin/ebook/tambahAct') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="gambar" type="file" name="sampul" class="form-control" accept=".png, .jpg, .jpeg"required>
                                ...
                                <div class="col-lg-4 col-12">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <a href="{{ url('SuperAdmin/ebook') }}" class="btn btn-warning">BATAL</a>
