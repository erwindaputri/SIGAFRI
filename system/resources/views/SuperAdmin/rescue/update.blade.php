                            ...
                            <div class="row">
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor_telepon" value="{{ $list->nomor_telepon }}" class="form-control" placeholder="Nomor Telepon/WA ..."required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" value="{{ $list->alamat }}" class="form-control" placeholder="Alamat ..."required>
                                    </div>
                                </div>
